package at.aau.intermediateModelHelper.envirorment.temporalTypes.structure;
...
public class TimeParameterMethod extends TimeMethod {
    ...
    public TimeParameterMethod(String className, String methodName, List<String> signature, int[] timeouts, TimeType[] timeType) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TimeParameterMethod)) return false;
        TimeParameterMethod that = (TimeParameterMethod) o;
